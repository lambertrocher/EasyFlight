...
import { QualificationDialogComponent } from '../../../../../../main/webapp/app/entities/qualification/qualification-dialog.component';
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'qualificationListModification', content: 'OK'});
