...
import com.mycompany.myapp.repository.QualificationRepository;
import com.mycompany.myapp.repository.search.QualificationSearchRepository;
...
public class QualificationResourceIntTest {
    ...
    private static final String DEFAULT_TYPE_QUALIFICATION = "AAAAAAAAAA";
    private static final String UPDATED_TYPE_QUALIFICATION = "BBBBBBBBBB";
    ...
    public static Qualification createEntity(EntityManager em) {
        Qualification qualification = new Qualification()
            ...
            .typeQualification(DEFAULT_TYPE_QUALIFICATION);
    ...
    public void createQualification() throws Exception {
        ...
        assertThat(testQualification.getExpiration()).isEqualTo(DEFAULT_EXPIRATION);
        assertThat(testQualification.getTypeQualification()).isEqualTo(DEFAULT_TYPE_QUALIFICATION);
        ...
        assertThat(qualificationEs).isEqualToIgnoringGivenFields(testQualification);
    }
    ...
    public void getAllQualifications() throws Exception {
        ...
        restQualificationMockMvc.perform(get("/api/qualifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].typeQualification").value(hasItem(DEFAULT_TYPE_QUALIFICATION.toString())));
    }
    ...
    public void getQualification() throws Exception {
        ...
        restQualificationMockMvc.perform(get("/api/qualifications/{id}", qualification.getId()))
            ...
            .andExpect(jsonPath("$.typeQualification").value(DEFAULT_TYPE_QUALIFICATION.toString()));
    }
    ...
    public void updateQualification() throws Exception {
        ...
        updatedQualification
            ...
            .typeQualification(UPDATED_TYPE_QUALIFICATION);
        ...
        Qualification testQualification = qualificationList.get(qualificationList.size() - 1);
        assertThat(testQualification.getExpiration()).isEqualTo(UPDATED_EXPIRATION);
        assertThat(testQualification.getTypeQualification()).isEqualTo(UPDATED_TYPE_QUALIFICATION);
